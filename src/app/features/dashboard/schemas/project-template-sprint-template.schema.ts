...
export const updateProjectTemplateSprintTemplateSchema =
  ProjectTemplateSprintTemplateSchema.partial();

export type ZProjectTemplateSprintTemplate = z.infer<typeof ProjectTemplateSprintTemplateSchema>;
export type ZProjectTemplateSprintTemplateInsert = z.infer<
  typeof insertProjectTemplateSprintTemplateSchema
>;
export type ZProjectTemplateSprintTemplateUpdate = z.infer<
  typeof updateProjectTemplateSprintTemplateSchema
>;
