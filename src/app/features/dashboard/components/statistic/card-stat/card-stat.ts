...
import { ICardStat } from '@app/features/dashboard/models/components/static.model';

@Component({
  selector: 'app-card-stat',
  imports: [CommonModule, ProgressBar, NgOptimizedImage],
  templateUrl: './card-stat.html',
  styleUrl: './card-stat.css',
})
export class CardStat {
cardStat = input<ICardStat>({
    title: '',
    value: '',
    change: '',
    trend: 'up',
...
getColorClass(color: string): string {
  ...
  getIconPath(icon: string): string {
    const icons: Record<string, string> = {
      ...
      target: 'M22 12A10 10 0 1 1 12 2a10 10 0 0 1 10 10zM12 6a6 6 0 1 0 0 12 6 6 0 0 0 0-12zM12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4z',
