...
export class ProjectTemplateSprintTemplateService {
    ...
    getAllProjectTemplateSprintTemplate(): Observable<IProjectTemplateSprintTemplate[]> {
        return this.httpClient.get<IHydraCollection<IProjectTemplateSprintTemplate>>(this.routeApi).pipe(
            map(response => {
    ...
    createProjectTemplateSprintTemplate(body: IProjectTemplateSprintTemplate): Observable<IProjectTemplateSprintTemplate> {
    ...
    updateProjectTemplateSprintTemplate(id: string, body: IProjectTemplateSprintTemplate): Observable<IProjectTemplateSprintTemplate> {
        const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
        return this.httpClient.patch<IProjectTemplateSprintTemplate>(`${this.routeApi}/${id}`, body, { headers });
    }
